    ...
    <div class="cadastro-enviado" >
            ...
            <div class="container"><br><br>
               ...
               <div class="view view-third">
                    ...
                    <div class="mask">
                        <h2>Escritórios</h2>
                        <p>Móveis personalizados para seu escritório.</p>
                        <a href="ambientes/escritorios.html" class="info">Veja +</a>
                    </div>  <h3>Escritórios</h3>
                </div>
                <div class="view view-third">
                    <img src="images/tumb-salas.jpg" />
                    <div class="mask">
                        <h2>Salas</h2>
                        <p>Móveis planejados sob medida para sua sala.</p>
                        <a href="ambientes/salas.html" class="info">Veja +</a>
                    </div> <h3>Salas</h3>
                </div>
                <div class="view view-third">
                ...
                <div class="view view-third">
                    ...
                    <div class="mask">
                        <h2>Cozinhas</h2>
                        <p>Cozinhas planejadas para sua necessidade.</p>
                        <a href="ambientes/cozinhas.html" class="info">Veja +</a>
                    </div> <h3>Cozinhas</h3>
                </div>
                <div class="view view-third">
                ...
                <div class="view2 view-third">
                    <img src="images/tumb-decorado.jpg" />
                    <div class="mask">
                        <h2>Decorado</h2>
                        <p>Veja nosso projeto de apartamento decorado.</p>
                        <a href="ambientes/apartamento-decorado.html" class="info">Veja +</a>
                    </div> <h3>Conheça nosso projeto de Decorado</h3>
                </div>
